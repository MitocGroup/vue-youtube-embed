  ...
  methods: {
    ...
    update: function update(videoId) {
      var _playerVars = this.playerVars,
          playerVars = _playerVars === undefined ? { autoplay: 0 } : _playerVars;
    ...
    this.$nextTick(function () {
      ...
      container.register(function (YouTube) {
        var _playerHeight = _this3.playerHeight,
            height = _playerHeight === undefined ? '390' : _playerHeight,
            _playerWidth = _this3.playerWidth,
            width = _playerWidth === undefined ? '640' : _playerWidth,
            _playerVars2 = _this3.playerVars,
            playerVars = _playerVars2 === undefined ? { autoplay: 0, start: 0 } : _playerVars2,
